<?php
namespace SpeckPaypalTest\Direct;
...
use SpeckPaypal\Direct\Capture;
...
class DirectPaymentTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $payment = new Payment(array('paymentDetails' => new \SpeckPaypal\Element\PaymentDetails('10.00')));
